...
\textbf{Chapter~\ref{chap:background}:Background} introduces the
...
\textbf{Chapter~\ref{chap:kzg}:KZG Polynomial Commitment} presents
...
\textbf{Chapter~\ref{chap:mkzg}:Multilinear KZG Polynomial
Commitment} extends KZG to multilinear polynomials. It describes the
...
\textbf{Chapter~\ref{chap:bulletproofs}:Bulletproofs} describes
...
\textbf{Chapter~\ref{chap:dory}:Dory Polynomial Commitment}
...
\textbf{Chapter~\ref{chap:comparison}:Comparative Analysis}
